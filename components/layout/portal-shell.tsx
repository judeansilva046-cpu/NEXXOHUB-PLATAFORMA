...
const portalMenus: Record<Exclude<PortalType, 'nexxohub'>, MenuItem[]> = {
  clinic: [
    ...
    { label: 'Diagnósticos', href: '/clinic/diagnostics', icon: ShieldCheck },
    { label: 'Programas', href: '/clinic/programs', icon: GraduationCap },
    { label: 'Trilhas e Módulos', href: '/clinic/tracks', icon: Network },
    { label: 'Aulas', href: '/clinic/classes', icon: BookOpen },
  ...
  company: [
    ...
    { label: 'Programas', href: '/company/programs', icon: GraduationCap },
    { label: 'Trilhas e Módulos', href: '/company/tracks', icon: Network },
    { label: 'Aulas', href: '/company/classes', icon: BookOpen },
